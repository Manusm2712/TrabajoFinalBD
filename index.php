...
<div class="container mt-5">
    ...
    <h1>Trabajo final BD1 - (Feline Zen)</h1>
    ...
    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="cliente/cliente.php">Entidad análoga a TALLER (CLIENTE)</a></li>
            <li><a href="cupon/cupon.php">Entidad análoga a MECANICO (CUPON)</a></li>
            <li><a href="servicio/servicio.php">Entidad análoga a REPARACION (SERVICIO)</a></li>
